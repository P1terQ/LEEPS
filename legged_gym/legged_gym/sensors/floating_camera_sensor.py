...
class FloatingCameraSensor(SensorBase):
    def __init__(self, env):
        ...
        self.recording_camera = self.env.gym.create_camera_sensor(self.env.envs[0], camera_props)
        self.env.gym.set_camera_location(self.recording_camera, self.env.envs[0], 
    ...
    def set_position(self, target_loc=None, cam_distance=None):
        ...
        self.env.gym.set_camera_location(self.recording_camera, self.env.envs[0], gymapi.Vec3(target_loc[0] + cam_distance[0],
    ...
    def get_observation(self, env_ids = None):
        ...
        img = self.env.gym.get_camera_image(self.env.sim, self.env.envs[0], self.recording_camera, gymapi.IMAGE_COLOR)
        w, h = img.shape
